...
float diff = 0.0; // global diff variable of the solver - this is the diff that decides the convergence of the grid - and weather to proceed with next iteration //SHARDED ADDDRESS SPACE
LOCK lock;
BARRIER barrier;
